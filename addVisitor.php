...
$sql = "SELECT identification FROM sajili WHERE username= ? ";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO visitors (username, identification, name, company, email, phone, ArrivalDate, expectedArrival, department, purpose, host, vehicle,card, status, date)
          VALUES ('$username','$identification', '$name', '$company', '$email', '$phone','$ArrivalDate','$expectedArrival','$department', '$purpose', '$host','$vehicle','$card','$status', NOW())";
  ...
  <div class="container mt-5">
    ...
    <?php endif; ?>
      <div class="mb-3">
        ...
        <input style="color: silver; " type="text" class="form-control" id="identification" name="identification" required >
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="tel" class="form-control" id="phone" name="phone" placeholder="+2547. . . . . . ." >
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="vehicle" name="vehicle" placeholder="Vehicle on site" >
      </div>
      <div class="mb-3">
        <label for="card" class="form-label">ISSING VISITOR'S CARD NUMBER</label>
